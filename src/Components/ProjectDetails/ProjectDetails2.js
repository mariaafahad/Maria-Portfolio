    ...
    return (
        <div>
            ...
            <section class="relative pt-12 m-8 bg-blueGray-50">
                <div class="items-center flex flex-wrap text-gray-100" data-aos="zoom-in-up">
                    <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
                        <img alt="..." class="max-w-full rounded-lg shadow-lg" src="https://i.ibb.co/ThRB5Cc/Screenshot-34.png" />
                    </div>
                    <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div class="md:pr-12">

                            <h3 class="text-3xl font-semibold">Project Name: <span className="text-yellow-900">Order For Foodie</span></h3>
                            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                                This Website is Online food delivery service website.
                            </p>
            ...
            <section class="relative pt-12 m-8 bg-blueGray-50">
                <div class="items-center flex flex-wrap text-gray-100" data-aos="zoom-in-up">
                    <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
                        <img alt="..." class="max-w-full rounded-lg shadow-lg" src="https://i.ibb.co/ZYwK0wq/food-2.png" />
                    </div>
                    <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div class="md:pr-12">
                            ...
                            <ul class="list-none mt-6">
                                ...
                                <li class="py-2">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h4 class="text-blueGray-500">Users can see their own order.</h4>
                                        </div>
                                    </div>
                                </li>
                                <li class="py-2">
            ...
            <section class="relative pt-12 m-8 bg-blueGray-50">
                <div class="items-center flex flex-wrap text-gray-100" data-aos="zoom-in-up">
                    <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
                        <img alt="..." class="max-w-full rounded-lg shadow-lg" src="https://i.ibb.co/qkzcn82/food-3.png" />
                    </div>
                    <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div class="md:pr-12">

                            <h3 class="text-3xl font-semibold">Section Name: <span className="text-yellow-900">Map Selection</span></h3>
                            <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                            ...
                            <ul class="list-none mt-6">
                                ...
                                <li class="py-2">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h4 class="text-blueGray-500 "> Livelink:<a className="underline" href="https://fragrance-universe.netlify.app/"> "https://dreamy-perlman-27a7f0.netlify.app/"</a></h4>
                                        </div>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h4 class="text-blueGray-500"> GitHub link:<a className="underline" href="https://github.com/mariaafahad/fragrance-universe-website"> "https://github.com/mariaafahad/order-for-foodie"</a></h4>
                                        </div>
                                    </div>
                                </li>
                            </ul>
