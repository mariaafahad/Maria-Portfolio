...
const Contact = () => {
    ...
    return (
        <div data-aos="zoom-in" id="contact" className="bg-gray-900">
            <h2 className="text-white  sm:text-4xl text-3xl mb-1 font-medium title-font my-36 underline">
                Contact Me
            </h2>
            <section className="container md-container sm-container px-5 pt-6 pb-8 mx-auto">
                <div className=" px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap border">
